...
$js = @("background.js", "popup.js", "options.js", "offscreen.js", "update.js", "wrapup.js", "lib-unzip.js", "lib-automation.js", "lib-availability.js", "lib-clickup.js", "lib-crypto.js", "lib-drive.js")
foreach ($f in $js) { node --check $f; if ($LASTEXITCODE -ne 0) { throw "Syntax error in $f" } }

# Package only what the extension needs.
$files = @("manifest.json", "background.js", "popup.html", "popup.js", "options.html", "options.js", "offscreen.html", "offscreen.js", "update.html", "update.js", "wrapup.html", "wrapup.js", "lib-unzip.js",
